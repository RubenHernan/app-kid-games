  ...
  <body>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="ahorcado.php" class="nav-link">Ahorcado</a></li>
                <li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown3">
						 <div  class="dropdown-item">
                            <div class="col-md-2">
                                <img id="user_profile" src="https://electronicssoftware.net/wp-content/uploads/user.png">
                            </div>
                            <table class="table">
                                <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <td id="user_given_name">Pedro</td>
                                </tr>
                                <tr>
                                    <th>Apellido</th>
                                    <td id="user_last_name">Lopez</td>
                                </tr>
                                <tr>
                                    <th>E-mail</th>
                                    <td id="user_email">lopez@gmail.com</td>
                                </tr>
                                </thead>
                            </table>
                         ...
                         <div class="float-right">
                            <a class="btn btn-outline-secondary" href="#" onclick="signOut();"><i class="fas fa-power-off"></i> Sign out </a>
                        </div>
                        </div>
    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <?php
				...
				$query = "SELECT Juego.Codigo, Tipo, Titulo,Tema.Descripcion,Fecha, tiempo FROM Juego INNER JOIN Tema ON Juego.codTema = Tema.Codigo where Juego.Privado=0 and Juego.Vigente = 1";
				$resultado = mysqli_query($conn, $query);
				while ($fila = mysqli_fetch_array($resultado)) { 
          $fechaComoEntero = strtotime($fila['Fecha']);
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              ...
              <?php 
              }else{ ?> <!-- para jugar memoria -->
                <a href="" class="block-20 d-flex align-items-end" style="background-image: url('../images/game3.jpg');">
              <?php
              }
              ...
              ?>
                  ...
                  <span class="yr"><?php echo $anio?></span>
                </div>
              </a>
              <div class="text bg-white p-4">
                <h3 class="heading"><?php echo $fila['Titulo']?></h3>
                <p>Tema: <?php echo $fila['Descripcion']?></p>
                <p>Tiempo: <?php echo $fila['tiempo']?></p>
